...
\begin{codebox}[commandchars=\\\{\}]
  \codeempha{%R0}<def> = \codeemphd{ADDrr} \codeemphb{%R0}<kill>, \codeemphc{%R1}<kill>
\end{codebox}
...
31...28 & 27...25 & 24...21 & 20 & 19...16 & 15...12 & 11...4 & 3...0\tabularnewline
\hline
1110 & 000 & \codeemphd{1100} & 0 & \codeemphb{0000} & \codeempha{0000} & 00000000 & \codeemphc{0001}\tabularnewline
\hline
\end{tabular}
