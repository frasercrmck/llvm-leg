...
\column{.5\textwidth}
    ...
    % FIXME regenerate graph
    \begin{block}{}
        \vspace{-8ex}
        \includegraphics[width = 1.0\textwidth]{examples/ex1-entry-selection-dag.pdf}
    \end{block}
\end{columns}    
...
\examplebox[firstline=7,lastline=8,gobble=1]{ex2-ADDrr-MOVW.s}
...
\examplebox[firstline=7,lastline=7,gobble=1]{ex2-ADDri.s}
...
\examplebox[firstline=7,lastline=10]{ex4.ll}

\begin{itemize}
    \item Output when compiled with -O2:
\end{itemize}

\examplebox[firstline=7,lastline=11]{ex4-O2.s}
...
\examplebox[firstline=1,lastline=10]{ex1.s}
