...
\column{.5\textwidth}
    \begin{block}{}
        \vspace{-8ex}
        \includegraphics[width = 1.0\textwidth]{examples/ex1-entry-machine-dag.pdf}
    \end{block}
\end{columns}
...
\column{.5\textwidth}
    \begin{block}{Before}
        \includegraphics[width = 0.95\textwidth]{examples/ex1-entry-selection-dag.pdf}
    \end{block}
\column{.5\textwidth}
    \begin{block}{After}
        \includegraphics[width = 0.95\textwidth]{examples/ex1-entry-machine-dag.pdf}
    \end{block}
\end{columns}
