...
\begin{frame}[fragile]{Assembly examples}

\begin{itemize}
    \item Simple function that adds two integers
    \begin{itemize}
        \item Function arguments are passed in registers
        \item lr contains the function's return address
    \end{itemize}
\end{itemize}
