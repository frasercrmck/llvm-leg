...
\begin{frame}{Codeplay}

  \begin{itemize}
    \item Based here in Edinburgh
    \item 31 exceedingly talented developers
    \item Some of the things we get up to:
      \begin{itemize}
        \item Compilers (customers' \& proprietary)
        \item Debuggers \& profilers
        \item Collaborative R\&D
        \item Academic collaborations
        \item Test-suites \& test infrastructure
        \item Helping define new standards
      \end{itemize}
    \item A lot of our work uses LLVM
  \end{itemize}
...
\begin{frame}{Partners and Customers}

\vspace{4ex}

\includegraphics[width = 1.0\textwidth]{Partners2.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Multiple basic blocks, branches
        \item Scheduling
        \item Intrinsics
        \item ...
    \end{itemize}
