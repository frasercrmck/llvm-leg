...
\DefineVerbatimEnvironment%
  {codebox}{Verbatim}
  {fontsize=\scriptsize,frame=single,tabsize=4}

\newcommand{\codecaption}[1]{%
  \vspace{-5ex}
  \hfill\mbox{\footnotesize{#1}\hspace{0.5em}}
  \vspace*{2ex}}

\newcommand{\sourcebox}[3][firstline=1]{%
  \fvset{fontsize=\scriptsize,frame=single,tabsize=4}
  \VerbatimInput[#1]{#2}
  \codecaption{#3}}

\newcommand{\examplebox}[2][firstline=1]{\sourcebox[#1]{examples/#2}{#2}}

\newcommand{\codeempha}[1]{\textcolor{red}{#1}}
